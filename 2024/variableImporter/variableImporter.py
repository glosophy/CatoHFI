...
main_ef = ['ef_government', 'ef_legal-gender', 'ef_money', 'ef_trade', 'ef_regulation']
...
other_cat_ef = ['ef_government_consumption', 'ef_government_transfers',
                ...
                'ef_legal_integrity', 'ef_legal_contracts', 'ef_legal_realprop',
                ...
                'ef_trade_movement', 'ef_regulation_credit', 'ef_regulation_labor', 'ef_regulation_business', 'ef_regulation_enter']
...
all_ef = ['ef_government', 'ef_government_consumption', 'ef_government_transfers', 'ef_government_investment',
          'ef_government_tax', 'ef_government_soa', 'ef_legal-gender', 'ef_legal_judicial', 'ef_legal_courts',
          'ef_legal_protection', 'ef_legal_military', 'ef_legal_integrity', 'ef_legal_contracts',
          'ef_legal_realprop', 'ef_legal_police', 'ef_money', 'ef_money_growth', 'ef_money_sd', 'ef_money_inflation',
          'ef_money_currency', 'ef_trade', 'ef_trade_tariffs', 'ef_trade_regulatory', 'ef_trade_black',
          'ef_trade_movement', 'ef_regulation', 'ef_regulation_credit', 'ef_regulation_labor', 'ef_regulation_business', 'ef_regulation_enter']

country_file = ['Albania', 'Algeria', 'Angola', 'Argentina', 'Armenia', 'Australia', 'Austria', 'Azerbaijan',
                ...
                'Jamaica', 'Japan', 'Jordan', 'Kazakhstan', 'Kenya', 'Korea', 'Kuwait', 'Kyrgyz Republic',
...
ranking2022 = [int(i) for i in df.loc[df['year'] == 2022, 'hf_rank']]
hfscore2022 = [str('{:.2f}'.format(i)) for i in df.loc[df['year'] == 2022, 'hf_score']]  # two decimal points
rankingpf = [(str(int(i)) + '/165') for i in df.loc[df['year'] == 2022, 'pf_rank']]
rankingef = [(str(int(i)) + '/165') for i in df.loc[df['year'] == 2022, 'ef_rank']]
pfscore2022 = [str('{:.2f}'.format(i)) for i in df.loc[df['year'] == 2022, 'pf_score']]  # two decimal points
efscore2022 = [str('{:.2f}'.format(i)) for i in df.loc[df['year'] == 2022, 'ef_score']]  # two decimal points
...
for i in country:
    ...
    for j in main_pf:
        x = df.loc[(df['year'] == 2022) & (df['countries'] == i), j]
        pf.append(float(x))

    for k in main_ef:
        x = df.loc[(df['year'] == 2022) & (df['countries'] == i), k]
        ef.append(float(x))

    for l in other_cat_pf:
        x = df.loc[(df['year'] == 2022) & (df['countries'] == i), l]
        other_pf.append(float(x))

    for m in other_cat_ef:
        x = df.loc[(df['year'] == 2022) & (df['countries'] == i), m]
...
for co in range(len(country)):
    ...
    for j in all_pf:
        x = df.loc[(df['year'] == 2022) & (df['countries'] == country[co]), j]
        pf.append(float(x))

    for k in all_ef:
        x = df.loc[(df['year'] == 2022) & (df['countries'] == country[co]), k]
        ef.append(float(x))
    ...
    w.to_csv('/Users/guillermina/Dropbox/Human Freedom Index/2024/Data/GraphPF/{}.csv'.format(country_file[co]),
    ...
    w = pd.DataFrame(ef)
    w = w.fillna(0)  # fillna with 0 for the bar chart
    w.to_csv('/Users/guillermina/Dropbox/Human Freedom Index/2024/Data/GraphEF/{}.csv'.format(country_file[co]),
             index=False, header=False)

# human freedom chart - order: country, world, region
selected = pd.read_csv('../../2024/selected_countries.csv')
...
for i in range(len(country)):
    ...
    graph_df.to_csv(
        '/Users/guillermina/Dropbox/Human Freedom Index/2024/Data/GraphHF/{}.csv'.format(country_file[i]),
        index=False, header=False)
...
for i in range(len(country)):
    ...
    w.to_csv('/Users/guillermina/Dropbox/Human Freedom Index/2024/Data/GraphRank/{}.csv'.format(country_file[i]),
             index=False, header=False)
...
d = {
    ...
    '%graphpf': ['/Users/guillermina/Dropbox/Human Freedom Index/2024/Data/GraphPF/{}.csv'.format(co) for co in
                 country_file],
    'listscoreefmain': final_ef_main,
    'listscoreef': final_other_ef_main,
    '%graphef': ['/Users/guillermina/Dropbox/Human Freedom Index/2024/Data/GraphEF/{}.csv'.format(co) for co in
                 country_file],
    '%graphscorehf': ['/Users/guillermina/Dropbox/Human Freedom Index/2024/Data/GraphHF/{}.csv'.format(co) for co
                      in country_file],
    '%graphrankinghf': ['/Users/guillermina/Dropbox/Human Freedom Index/2024/Data/GraphRank/{}.csv'.format(co) for
                        co in country_file],

    'main2022': list_score_pf_main_page2[0],
    'main2020': list_score_pf_main_page2[2],
    'main2018': list_score_pf_main_page2[4],
    'main2016': list_score_pf_main_page2[6],
    'main2014': list_score_pf_main_page2[8],
    'main2012': list_score_pf_main_page2[10],
    'main2010': list_score_pf_main_page2[12],
    'main2008': list_score_pf_main_page2[14],
    'main2006': list_score_pf_main_page2[16],
    'main2004': list_score_pf_main_page2[18],
    'main2002': list_score_pf_main_page2[20],
    'main2000': list_score_pf_main_page2[22],

    'sub2022': list_score_other_pf_main_page2[0],
    'sub2020': list_score_other_pf_main_page2[2],
    'sub2018': list_score_other_pf_main_page2[4],
    'sub2016': list_score_other_pf_main_page2[6],
    'sub2014': list_score_other_pf_main_page2[8],
    'sub2012': list_score_other_pf_main_page2[10],
    'sub2010': list_score_other_pf_main_page2[12],
    'sub2008': list_score_other_pf_main_page2[14],
    'sub2006': list_score_other_pf_main_page2[16],
    'sub2004': list_score_other_pf_main_page2[18],
    'sub2002': list_score_other_pf_main_page2[20],
    'sub2000': list_score_other_pf_main_page2[22],
    ...
    'dscore2016': dscore[6],
    'dscore2014': dscore[8],
    'dscore2012': dscore[10],
    'dscore2010': dscore[12],
    'dscore2008': dscore[14],
    'dscore2006': dscore[16],
    'dscore2004': dscore[18],
    'dscore2002': dscore[20],
    'dscore2000': dscore[22],
    ...
    'ranking2022': rank_years[0],
    'ranking2020': rank_years[2],
    'ranking2018': rank_years[4],
    'ranking2016': rank_years[6],
    'ranking2014': rank_years[8],
    'ranking2012': rank_years[10],
    'ranking2010': rank_years[12],
    'ranking2008': rank_years[14],
    'ranking2006': rank_years[16],
    'ranking2004': rank_years[18],
    'ranking2002': rank_years[20],
    'ranking2000': rank_years[22]
...
df_final.to_csv('/Users/guillermina/Dropbox/Human Freedom Index/2024/Data/final.csv', index=False)
