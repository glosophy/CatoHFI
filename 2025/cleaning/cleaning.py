...
# read csv
df = pd.read_csv('../../2025/HFI2025cc.csv')
...
df.columns = ['year', 'iso', 'countries', 'region', 'hf_score', 'hf_rank', 'hf_quartile',
              ...
              'pf_score', 'pf_rank',
              # government
              'ef_government_consumption_nointerest', 'ef_government_consumption_nointerest_data',
              'ef_government_consumption_withinterest', 'ef_government_consumption_withinterest_data',
              ...
              'ef_government_tax_payroll_data', 'ef_government_tax', 'ef_government_soa', 'ef_government', 'ef_government_rank',
              # legal
              'ef_legal_judicial', 'ef_legal_courts', 'ef_legal_protection', 'ef_legal_military', 'ef_legal_integrity',
              'ef_legal_contracts', 'ef_legal_realprop', 'ef_legal_police', 'ef_gender', 'ef_legal-nogender',
              'ef_legal-gender', 'ef_legal_rank',
              # money
              'ef_money_growth', 'ef_money_growth_data', 'ef_money_sd', 'ef_money_sd_data', 'ef_money_inflation',
              'ef_money_inflation_data', 'ef_money_currency', 'ef_money', 'ef_money_rank',
              # trade
              ...
              'ef_trade_regulatory_nontariff', 'ef_trade_regulatory_costs', 'ef_trade_regulatory',
              'ef_trade_black', 'ef_trade_movement_open', 'ef_trade_movement_capital', 'ef_trade_movement_visit',
              'ef_trade_movement_assets', 'ef_trade_movement', 'ef_trade', 'ef_trade_rank',
              # regulation
              ...
              'ef_regulation_labor_firing', 'ef_regulation_labor_flexible', 'ef_regulation_labor_hours',
              'ef_regulation_labor_dismissal', 'ef_regulation_labor_conscription', 'ef_regulation_labor_foreign',
              'ef_regulation_labor', 'ef_regulation_business_burden', 'ef_regulation_business_costs',
              'ef_regulation_business_impartial', 'ef_regulation_business_compliance',
              'ef_regulation_business', 'ef_regulation_enter_openness', 'ef_regulation_enter_permits',
              'ef_regulation_enter_distortion', 'ef_regulation_enter', 'ef_regulation', 'ef_regulation_rank',
              # economic freedom
              'ef_score', 'ef_rank']

df.to_csv('hfi2025_cc.csv', index=False)
