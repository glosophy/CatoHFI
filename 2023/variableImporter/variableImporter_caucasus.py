...
# read csv
df = pd.read_csv('../../2023/cleaning/caucasus_ccopy.csv')
country_file = ['Armenia', 'Azerbaijan', 'Georgia', 'Kazakhstan', 'Kyrgyz Republic', 'Tajikistan']
...
df_final.to_csv('/Users/guillermina/Dropbox/Human Freedom Index/2023/Data/final_caucasus.csv', index=False)
df_final.to_csv('final_caucasus.csv', index=False)
