...
# read csv
df = pd.read_csv('../../2023/cleaning/hfi2023_ccopy.csv')
...
ranking2021 = [int(i) for i in df.loc[df['year'] == 2021, 'hf_rank']]
hfscore2021 = [str('{:.2f}'.format(i)) for i in df.loc[df['year'] == 2021, 'hf_score']]  # two decimal points
rankingpf = [(str(int(i)) + '/165') for i in df.loc[df['year'] == 2021, 'pf_rank']]
rankingef = [(str(int(i)) + '/165') for i in df.loc[df['year'] == 2021, 'ef_rank']]
pfscore2021 = [str('{:.2f}'.format(i)) for i in df.loc[df['year'] == 2021, 'pf_score']]  # two decimal points
efscore2021 = [str('{:.2f}'.format(i)) for i in df.loc[df['year'] == 2021, 'ef_score']]  # two decimal points
...
for i in country:
    ...
    for j in main_pf:
        x = df.loc[(df['year'] == 2021) & (df['countries'] == i), j]
        pf.append(float(x))

    for k in main_ef:
        x = df.loc[(df['year'] == 2021) & (df['countries'] == i), k]
        ef.append(float(x))

    for l in other_cat_pf:
        x = df.loc[(df['year'] == 2021) & (df['countries'] == i), l]
        other_pf.append(float(x))

    for m in other_cat_ef:
        x = df.loc[(df['year'] == 2021) & (df['countries'] == i), m]
...
for co in range(len(country)):
    ...
    for j in all_pf:
        x = df.loc[(df['year'] == 2021) & (df['countries'] == country[co]), j]
        pf.append(float(x))

    for k in all_ef:
        x = df.loc[(df['year'] == 2021) & (df['countries'] == country[co]), k]
        ef.append(float(x))
    ...
    w.to_csv('/Users/guillermina/Dropbox/Human Freedom Index/2023/Data/GraphPF/{}.csv'.format(country_file[co]),
    ...
    w = pd.DataFrame(ef)
    w = w.fillna(0)  # fillna with 0 for the bar chart
    w.to_csv('/Users/guillermina/Dropbox/Human Freedom Index/2023/Data/GraphEF/{}.csv'.format(country_file[co]),
             index=False, header=False)

# human freedom chart - order: country, world, region
selected = pd.read_csv('../../2023/selected_countries.csv')
...
for i in range(len(country)):
    ...
    graph_df.to_csv(
        '/Users/guillermina/Dropbox/Human Freedom Index/2023/Data/GraphHF/{}.csv'.format(country_file[i]),
        index=False, header=False)
...
for i in range(len(country)):
    ...
    w.to_csv('/Users/guillermina/Dropbox/Human Freedom Index/2023/Data/GraphRank/{}.csv'.format(country_file[i]),
             index=False, header=False)
...
d = {
    ...
    '%graphpf': ['/Users/guillermina/Dropbox/Human Freedom Index/2023/Data/GraphPF/{}.csv'.format(co) for co in
                 country_file],
    'listscoreefmain': final_ef_main,
    'listscoreef': final_other_ef_main,
    '%graphef': ['/Users/guillermina/Dropbox/Human Freedom Index/2023/Data/GraphEF/{}.csv'.format(co) for co in
                 country_file],
    '%graphscorehf': ['/Users/guillermina/Dropbox/Human Freedom Index/2023/Data/GraphHF/{}.csv'.format(co) for co
                      in country_file],
    '%graphrankinghf': ['/Users/guillermina/Dropbox/Human Freedom Index/2023/Data/GraphRank/{}.csv'.format(co) for
                        co in country_file],

    'main2021': list_score_pf_main_page2[0],
    'main2020': list_score_pf_main_page2[1],
    'main2019': list_score_pf_main_page2[2],
    'main2016': list_score_pf_main_page2[5],
    'main2014': list_score_pf_main_page2[7],
    'main2012': list_score_pf_main_page2[9],
    'main2010': list_score_pf_main_page2[11],
    'main2008': list_score_pf_main_page2[13],
    'main2006': list_score_pf_main_page2[15],
    'main2004': list_score_pf_main_page2[17],
    'main2002': list_score_pf_main_page2[19],
    'main2000': list_score_pf_main_page2[21],

    'sub2021': list_score_other_pf_main_page2[0],
    'sub2020': list_score_other_pf_main_page2[1],
    'sub2019': list_score_other_pf_main_page2[2],
    'sub2016': list_score_other_pf_main_page2[5],
    'sub2014': list_score_other_pf_main_page2[7],
    'sub2012': list_score_other_pf_main_page2[9],
    'sub2010': list_score_other_pf_main_page2[11],
    'sub2008': list_score_other_pf_main_page2[13],
    'sub2006': list_score_other_pf_main_page2[15],
    'sub2004': list_score_other_pf_main_page2[17],
    'sub2002': list_score_other_pf_main_page2[19],
    'sub2000': list_score_other_pf_main_page2[21],
    ...
    'dscore2014': dscore[7],
    'dscore2012': dscore[9],
    'dscore2010': dscore[11],
    'dscore2008': dscore[12],
    'dscore2006': dscore[15],
    'dscore2004': dscore[17],
    'dscore2002': dscore[19],
    'dscore2000': dscore[21],
    ...
    'ranking2021': rank_years[0],
    'ranking2020': rank_years[1],
    'ranking2019': rank_years[2],
    'ranking2016': rank_years[5],
    'ranking2014': rank_years[7],
    'ranking2012': rank_years[9],
    'ranking2010': rank_years[11],
    'ranking2008': rank_years[13],
    'ranking2006': rank_years[15],
    'ranking2004': rank_years[17],
    'ranking2002': rank_years[19],
    'ranking2000': rank_years[21]
...
df_final.to_csv('/Users/guillermina/Dropbox/Human Freedom Index/2023/Data/final.csv', index=False)
